...
local MINOR_VERSION = "$Revision: 16322 $"
...
local SHOW_ICON = "显示图标"
local SHOW_ICON_DESC = "在面板上显示插件图标。"
local SHOW_TEXT = "显示文本"
local SHOW_TEXT_DESC = "在面板上显示插件文本。"
local SHOW_COLORED_TEXT = "显示彩色文本"
local SHOW_COLORED_TEXT_DESC = "允许插件将其文本着色。"
local DETACH_TOOLTIP = "分离提示信息"
local DETACH_TOOLTIP_DESC = "将提示信息从面板上分离。"
local LOCK_TOOLTIP = "锁定提示信息"
local LOCK_TOOLTIP_DESC = "锁定提示信息的位置。当提示信息被锁定时，你必须使用Alt键才能用鼠标访问它。"
local POSITION = "位置"
local POSITION_DESC = "在面板上设置插件的位置。"
local POSITION_LEFT = "左侧"
local POSITION_RIGHT = "右侧"
local POSITION_CENTER = "中间"
local ATTACH_TO_MINIMAP = "附着到小地图"
local ATTACH_TO_MINIMAP_DESC = "将插件附着在小地图而不是面板上。"
local HIDE_FUBAR_PLUGIN = "隐藏插件"
local HIDE_FUBAR_PLUGIN_CMD = "隐藏"
local HIDE_FUBAR_PLUGIN_DESC = "从面板或小地图上隐藏插件，让插件继续运行。"
...
elseif GetLocale() == "zhCN" then
	...
	SHOW_TEXT = "显示文本"
	SHOW_TEXT_DESC = "在面板上显示插件文本。"
	SHOW_COLORED_TEXT = "显示彩色文本"
	SHOW_COLORED_TEXT_DESC = "允许插件将其文本着色。"
	DETACH_TOOLTIP = "分离提示信息"
	DETACH_TOOLTIP_DESC = "将提示信息从面板上分离。"
	LOCK_TOOLTIP = "锁定提示信息"
	LOCK_TOOLTIP_DESC = "锁定提示信息的位置。当提示信息被锁定时，你必须使用Alt键才能用鼠标访问它。"
	POSITION = "位置"
	POSITION_DESC = "在面板上设置插件的位置。"
	POSITION_LEFT = "左侧"
	POSITION_RIGHT = "右侧"
	POSITION_CENTER = "中间"
	ATTACH_TO_MINIMAP = "附着到小地图"
	ATTACH_TO_MINIMAP_DESC = "将插件附着在小地图而不是面板上。"
	HIDE_FUBAR_PLUGIN = "隐藏插件"
	HIDE_FUBAR_PLUGIN_CMD = "隐藏"
	HIDE_FUBAR_PLUGIN_DESC = "从面板或小地图上隐藏插件，让插件继续运行。"
